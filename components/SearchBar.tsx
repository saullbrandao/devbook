...
export const SearchBar = ({ rounded }: SearchBarProps) => {
  ...
  return (
    <div className={`bg-purple-light ${rounded ? 'md:rounded-full border-primary md:border-4 lg:w-1/3' : 'rounded-md '} flex h-14 order-last md:order-none col-span-2`}>
      <input
      ...
      />
      <button
        className={`bg-primary flex-grow-0 ${rounded ? 'md:rounded-full' : 'rounded-r-md'}  focus:outline-none`}
